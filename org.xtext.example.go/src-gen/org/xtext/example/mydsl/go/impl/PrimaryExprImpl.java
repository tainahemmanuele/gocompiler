 ...
 *   <li>{@link org.xtext.example.mydsl.go.impl.PrimaryExprImpl#getEmpty <em>Empty</em>}</li>
...
public class PrimaryExprImpl extends TypeSwitchGuardImpl implements PrimaryExpr
{
  ...
  public void setEmpty(String newEmpty)
  {
    ...
    empty = newEmpty;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoPackage.PRIMARY_EXPR__EMPTY, oldEmpty, empty));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case GoPackage.PRIMARY_EXPR__POSTSTMT:
        return getPoststmt();
      case GoPackage.PRIMARY_EXPR__EMPTY:
        return getEmpty();
      case GoPackage.PRIMARY_EXPR__RECVEXPR:
        return getRecvexpr();
      case GoPackage.PRIMARY_EXPR__KEYEDELEMENT:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == SimpleStmt.class)
    {
      switch (derivedFeatureID)
      {
        case GoPackage.PRIMARY_EXPR__EMPTY: return GoPackage.SIMPLE_STMT__EMPTY;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == SimpleStmt.class)
    {
      switch (baseFeatureID)
      {
        case GoPackage.SIMPLE_STMT__EMPTY: return GoPackage.PRIMARY_EXPR__EMPTY;
        default: return -1;
      }
    }
    if (baseClass == ExpressionStmt.class)
