...
@after {
	...
	(
		...
		{
			$current = $this_InterfaceType_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_SliceType_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ChannelType_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_PointerType_7.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getBlockAccess().getStmtlStatementListParserRuleCall_1_0());
				}
				lv_stmtl_1_0=ruleStatementList
				{
					if ($current==null) {
...
@after {
	...
	(
		(
			{
				newCompositeNode(grammarAccess.getFunctionBodyAccess().getBcBlockParserRuleCall_0());
			}
			lv_bc_0_0=ruleBlock
			{
				if ($current==null) {
