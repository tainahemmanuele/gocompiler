...
public class GoSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GoPackage.eINSTANCE)
			...
			case GoPackage.EXPRESSION:
				if (rule == grammarAccess.getTypeRule()
					...
					return; 
						...
						|| rule == grammarAccess.getSimpleStmtRule()
					...
					sequence_Expression_ForClause(context, (Expression) semanticObject); 
					return; 
				}
					...
					return; 
						...
						|| rule == grammarAccess.getTypeSwitchStmtRule()) {
					sequence_Expression_TypeSwitchStmt(context, (Expression) semanticObject); 
					return; 
				}
				else break;
			...
			case GoPackage.PARAMETERS:
				if (rule == grammarAccess.getLiteralRule()
			...
			case GoPackage.SHORT_VAR_DECL:
				if (rule == grammarAccess.getForClauseRule()) {
					sequence_ForClause_ShortVarDecl(context, (ShortVarDecl) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getSimpleStmtRule()
					...
					return; 
						...
						|| rule == grammarAccess.getTypeSwitchStmtRule()) {
					sequence_ShortVarDecl_TypeSwitchStmt(context, (ShortVarDecl) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *     ElementType returns Expression
	 *     BaseType returns Expression
	 *     Result returns Expression
	 *     KeyType returns Expression
	 *     TypeAssertion returns Expression
	 *
	 * Constraint:
	 ...
	 *
	 * Constraint:
	 *     (expressionlist=ExpressionList asop=ASSING_OP expressionlist2=ExpressionList condition=Condition? poststmt=PostStmt)
	 */
	 ...
	 *
	 * Constraint:
	 *     (expressionlist=ExpressionList asop=ASSING_OP expressionlist2=ExpressionList typesg=TypeSwitchGuard typecc+=TypeCaseClause*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (up=UnaryExpr exp=Expression2 condition=Condition? poststmt=PostStmt)
	 */
	protected void sequence_Expression_ForClause(ISerializationContext context, Expression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     TypeSwitchStmt returns Expression
	 *
	 * Constraint:
	 *     (up=UnaryExpr exp=Expression2 typesg=TypeSwitchGuard typecc+=TypeCaseClause*)
	 */
	protected void sequence_Expression_TypeSwitchStmt(ISerializationContext context, Expression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     ForClause returns ShortVarDecl
	 *
	 * Constraint:
	 *     (idl=IdentifierList epl=ExpressionList condition=Condition? poststmt=PostStmt)
	 */
	protected void sequence_ForClause_ShortVarDecl(ISerializationContext context, ShortVarDecl semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     SimpleStmt returns ShortVarDecl
	 *     ShortVarDecl returns ShortVarDecl
	 *     InitStmt returns ShortVarDecl
	 *     PostStmt returns ShortVarDecl
	 *
	 * Constraint:
	...
	/**
	 * Contexts:
	 *     SwitchStmt returns ShortVarDecl
	 *     TypeSwitchStmt returns ShortVarDecl
	 *
	 * Constraint:
	 *     (idl=IdentifierList epl=ExpressionList typesg=TypeSwitchGuard typecc+=TypeCaseClause*)
	 */
	protected void sequence_ShortVarDecl_TypeSwitchStmt(ISerializationContext context, ShortVarDecl semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Type(ISerializationContext context, Type semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GoPackage.Literals.TYPE__TP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GoPackage.Literals.TYPE__TP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTypeAccess().getTpTypeNameParserRuleCall_0_1_0(), semanticObject.getTp());
		feeder.finish();
	}
