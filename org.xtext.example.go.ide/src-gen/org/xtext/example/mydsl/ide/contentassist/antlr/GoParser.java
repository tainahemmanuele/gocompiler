...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionNameAccess().getIdAssignment(), "rule__FunctionName__IdAssignment");
			...
			builder.put(grammarAccess.getPackageClauseAccess().getPackageAssignment_1(), "rule__PackageClause__PackageAssignment_1");
			...
			builder.put(grammarAccess.getTypeLitAccess().getArrayAssignment_0(), "rule__TypeLit__ArrayAssignment_0");
			builder.put(grammarAccess.getTypeLitAccess().getStructAssignment_1(), "rule__TypeLit__StructAssignment_1");
			builder.put(grammarAccess.getTypeLitAccess().getPointerAssignment_2(), "rule__TypeLit__PointerAssignment_2");
			builder.put(grammarAccess.getTypeLitAccess().getFunctionAssignment_3(), "rule__TypeLit__FunctionAssignment_3");
			builder.put(grammarAccess.getTypeLitAccess().getIntypeAssignment_4(), "rule__TypeLit__IntypeAssignment_4");
			builder.put(grammarAccess.getTypeLitAccess().getSliceAssignment_5(), "rule__TypeLit__SliceAssignment_5");
			builder.put(grammarAccess.getTypeLitAccess().getMapAssignment_6(), "rule__TypeLit__MapAssignment_6");
			builder.put(grammarAccess.getTypeLitAccess().getChannelAssignment_7(), "rule__TypeLit__ChannelAssignment_7");
			...
			builder.put(grammarAccess.getInterfaceTypeNameAccess().getTypenAssignment(), "rule__InterfaceTypeName__TypenAssignment");
			...
			builder.put(grammarAccess.getBlockAccess().getStatlistAssignment_1(), "rule__Block__StatlistAssignment_1");
			...
			builder.put(grammarAccess.getDeclarationAccess().getConstAssignment_0(), "rule__Declaration__ConstAssignment_0");
			builder.put(grammarAccess.getDeclarationAccess().getTyeAssignment_1(), "rule__Declaration__TyeAssignment_1");
			builder.put(grammarAccess.getDeclarationAccess().getVarAssignment_2(), "rule__Declaration__VarAssignment_2");
			...
			builder.put(grammarAccess.getGoStmtAccess().getLabelAssignment_1(), "rule__GoStmt__LabelAssignment_1");
			...
			builder.put(grammarAccess.getSwitchStmtAccess().getExpstmtAssignment_0(), "rule__SwitchStmt__ExpstmtAssignment_0");
			builder.put(grammarAccess.getSwitchStmtAccess().getTypessAssignment_1(), "rule__SwitchStmt__TypessAssignment_1");
			...
			builder.put(grammarAccess.getDeferStmtAccess().getExpAssignment_1(), "rule__DeferStmt__ExpAssignment_1");
			...
			builder.put(grammarAccess.getTypeSpecAccess().getAliasdeclAssignment_0(), "rule__TypeSpec__AliasdeclAssignment_0");
			builder.put(grammarAccess.getTypeSpecAccess().getTypedAssignment_1(), "rule__TypeSpec__TypedAssignment_1");
			...
			builder.put(grammarAccess.getUnaryExprAccess().getPrimaryAssignment_0(), "rule__UnaryExpr__PrimaryAssignment_0");
			...
			builder.put(grammarAccess.getKeyAccess().getExpAssignment_1(), "rule__Key__ExpAssignment_1");
			builder.put(grammarAccess.getKeyAccess().getLtvAssignment_2(), "rule__Key__LtvAssignment_2");
			builder.put(grammarAccess.getFieldNameAccess().getIdAssignment(), "rule__FieldName__IdAssignment");
			builder.put(grammarAccess.getElementAccess().getExpAssignment_0(), "rule__Element__ExpAssignment_0");
			builder.put(grammarAccess.getElementAccess().getLtvAssignment_1(), "rule__Element__LtvAssignment_1");
