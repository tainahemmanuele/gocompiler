...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypeNameAccess().getIdAssignment_0(), "rule__TypeName__IdAssignment_0");
			builder.put(grammarAccess.getTypeNameAccess().getQlAssignment_1(), "rule__TypeName__QlAssignment_1");
			builder.put(grammarAccess.getQualifiedIdentAccess().getPnAssignment_0(), "rule__QualifiedIdent__PnAssignment_0");
			builder.put(grammarAccess.getQualifiedIdentAccess().getIdAssignment_2(), "rule__QualifiedIdent__IdAssignment_2");
			...
			builder.put(grammarAccess.getParameterDeclAccess().getIdentifierLAssignment_0(), "rule__ParameterDecl__IdentifierLAssignment_0");
			...
			builder.put(grammarAccess.getSimpleStmtAccess().getEsAssignment_1(), "rule__SimpleStmt__EsAssignment_1");
			builder.put(grammarAccess.getSimpleStmtAccess().getSsAssignment_2(), "rule__SimpleStmt__SsAssignment_2");
			builder.put(grammarAccess.getSimpleStmtAccess().getIncAssignment_3(), "rule__SimpleStmt__IncAssignment_3");
			builder.put(grammarAccess.getSimpleStmtAccess().getAssAssignment_4(), "rule__SimpleStmt__AssAssignment_4");
			builder.put(grammarAccess.getSimpleStmtAccess().getSvdAssignment_5(), "rule__SimpleStmt__SvdAssignment_5");
			...
			builder.put(grammarAccess.getConstSpecAccess().getTpAssignment_2(), "rule__ConstSpec__TpAssignment_2");
			builder.put(grammarAccess.getConstSpecAccess().getExpressionlistAssignment_4(), "rule__ConstSpec__ExpressionlistAssignment_4");
			...
			builder.put(grammarAccess.getAliasDeclAccess().getIdAssignment_0(), "rule__AliasDecl__IdAssignment_0");
			builder.put(grammarAccess.getAliasDeclAccess().getTpAssignment_2(), "rule__AliasDecl__TpAssignment_2");
			...
			builder.put(grammarAccess.getVarSpecAccess().getTp2Assignment_1_0_0(), "rule__VarSpec__Tp2Assignment_1_0_0");
			...
			builder.put(grammarAccess.getVarSpecAccess().getElAssignment_1_1_1(), "rule__VarSpec__ElAssignment_1_1_1");
			...
			builder.put(grammarAccess.getAssignmentAccess().getAsopAssignment_1(), "rule__Assignment__AsopAssignment_1");
			...
			builder.put(grammarAccess.getShortVarDeclAccess().getIdlAssignment_0(), "rule__ShortVarDecl__IdlAssignment_0");
			builder.put(grammarAccess.getShortVarDeclAccess().getEplAssignment_2(), "rule__ShortVarDecl__EplAssignment_2");
			...
			builder.put(grammarAccess.getPostStmtAccess().getSimpleAssignment(), "rule__PostStmt__SimpleAssignment");
