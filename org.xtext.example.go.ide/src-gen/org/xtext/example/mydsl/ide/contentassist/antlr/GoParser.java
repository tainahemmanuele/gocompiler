...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVarSpecAccess().getEprlistAssignment_1_1_1(), "rule__VarSpec__EprlistAssignment_1_1_1");
			builder.put(grammarAccess.getExpressionStmtAccess().getExpAssignment(), "rule__ExpressionStmt__ExpAssignment");
			...
			builder.put(grammarAccess.getIncDecStmtAccess().getExpAssignment_0(), "rule__IncDecStmt__ExpAssignment_0");
			...
			builder.put(grammarAccess.getExpressionListAccess().getExpAssignment_0(), "rule__ExpressionList__ExpAssignment_0");
