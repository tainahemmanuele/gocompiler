...
public class GoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVarSpecAccess().getAlternatives_2(), "rule__VarSpec__Alternatives_2");
			...
			builder.put(grammarAccess.getVarSpecAccess().getGroup_2_0(), "rule__VarSpec__Group_2_0__0");
			builder.put(grammarAccess.getVarSpecAccess().getGroup_2_0_1(), "rule__VarSpec__Group_2_0_1__0");
			builder.put(grammarAccess.getVarSpecAccess().getGroup_2_1(), "rule__VarSpec__Group_2_1__0");
			...
			builder.put(grammarAccess.getVarSpecAccess().getIdAssignment_1(), "rule__VarSpec__IdAssignment_1");
			builder.put(grammarAccess.getVarSpecAccess().getTp2Assignment_2_0_0(), "rule__VarSpec__Tp2Assignment_2_0_0");
			builder.put(grammarAccess.getVarSpecAccess().getExpressionlistAssignment_2_0_1_1(), "rule__VarSpec__ExpressionlistAssignment_2_0_1_1");
			builder.put(grammarAccess.getVarSpecAccess().getElAssignment_2_1_1(), "rule__VarSpec__ElAssignment_2_1_1");
			...
			builder.put(grammarAccess.getConditionAccess().getExpAssignment(), "rule__Condition__ExpAssignment");
			builder.put(grammarAccess.getForClauseAccess().getInitAssignment_0(), "rule__ForClause__InitAssignment_0");
